...
// created on 20/06/2005 at 14:15
using Gtk;
using System;

/////////////////////////////////////////////////////////////////////
//Displays a "Yes" or "No" dialog box with a 'question' stock icon  /
/////////////////////////////////////////////////////////////////////
...
public class YesNoDialog : Dialog
{
	...
	public YesNoDialog (string title, string question, string explanation) : base ()
	{
		this.Title = title;
